        ...
        <div className="flex gap-5 justify-between w-4/5 mx-auto my-3 flex-1 p-4">
            ...
            {/* cards */}
                ...
                <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{duration: 0.8, delay: 0.5, ease: [0, 0.71, 0.2, 1.01]}} className="w-full bg-transparent flex gap-9">
                    <motion.div whileTap={{ scale: 0.7 }} className="p-5 flex justify-center gap-2 rounded-md transition-all bg-teal-600 text-white shadow-md flex-1 hover:bg-indigo-600">
                    ...
                    <motion.div whileTap={{ scale: 0.7 }} className="p-5 flex justify-center gap-2 rounded-md transition-all bg-slate-800 text-white shadow-md flex-1 hover:bg-indigo-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                    ...
                    <motion.div whileTap={{ scale: 0.7 }} className="p-5 flex justify-center gap-2 rounded-md transition-all bg-sky-600 text-white shadow-md flex-1 hover:bg-indigo-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
