...
export default function Sidebar() {
  return (
    <div className='h-[600px] w-[300px] p-5 bg-white rounded-lg shadow-md animate-fade-down animate-once animate-delay-200' initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{duration: 0.8, delay: 0.5, ease: [0, 0.71, 0.2, 1.01]}}>

        <ul className='px-3 pt-[80px] flex flex-col gap-4'>
            <li className='p-3 font-semibold uppercase text-sm transition-all hover:bg-slate-200 hover:ps-8 rounded-lg bg-gradient-to-r from-slate-800 to-slate-600 text-white flex items-center gap-3'>
            ...
            <li className='p-3 font-semibold uppercase text-sm transition-all text-gray-700 hover:bg-slate-200 hover:ps-8 rounded-lg flex items-center gap-3'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
